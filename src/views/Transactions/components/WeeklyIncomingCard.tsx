...
export const WeeklyIncomingCard = (props: WeeklyIncomingCardProps) => {
  ...
  return (
    <BaseCard className="!h-auto">
      <div className="flex flex-col gap-2 w-full">
        ...
        <p className="!text-4xl font-bold self-start poppins !text-bg-success">
