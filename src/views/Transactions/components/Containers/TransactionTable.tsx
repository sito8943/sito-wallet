...
import Autogenerated from "../../../TransactionCategories/components/Autogenerated/Autogenerated";
    ...
    [
      {
        ...
        renderBody: (_: string, entity: TransactionDto) =>
          entity.category?.initial ? <Autogenerated isTitle={false} /> : entity.category?.name,
      },
      {
        key: "description",
