...
vi.mock("components", async () => {
  const actual = await vi.importActual<
    typeof import("../../../../components/Card/SwipeToDelete")
  >("../../../../components/Card/SwipeToDelete");

  return {
    SwipeToDelete: actual.SwipeToDelete,
  };
});
  ...
  it("shows swipe delete affordance and triggers delete at 50% width", () => {
    ...
    render(
      <TransactionCard
        ...
        onClick={() => undefined}
        onSwipeDelete={() => onDelete(baseTransaction)}
      />,
    );
    ...
    expect(onDelete).toHaveBeenCalledWith(baseTransaction);
  });
});
